...
\draw[thick, fill=red] (0, 1) node [above left] {Diode (CdZnTe)} rectangle (7,2) ;
...
\draw[->, photon] (0,0) -- node [left] {Foton} (0:4);
\end{scope}


\draw[->, ultra thick] (4,2) -- node [right] {0011010010110} (4,4);
